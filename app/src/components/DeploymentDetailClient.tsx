...
export default function DeploymentDetailClient({ deployment_id }: DeploymentDetailClientProps) {
  ...
  useEffect(() => {
    if (!deployment || !deployment.latitude || !deployment.longitude || !mapContainer.current) return;
